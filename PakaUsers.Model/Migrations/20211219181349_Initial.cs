        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Client_Surname = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Personalities = table.Column<string>(type: "text", nullable: true),
                    ...
                    BusinessClientId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressBook_AspNetUsers_BusinessClientId",
                        column: x => x.BusinessClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AddressBook_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressBook_BusinessClientId",
                table: "AddressBook",
                column: "BusinessClientId");

            migrationBuilder.CreateIndex(
                name: "IX_AddressBook_ClientId",
                table: "AddressBook",
                column: "ClientId");
